...
export function GolsTopBar() {
  const [scope, setScope] = useState<"Rodada" | "Campeonato">("Rodada");

  return (
    <div className="bg-[#111827] border border-gray-800/60 rounded-2xl p-4 mb-6 flex flex-col sm:flex-row items-center justify-between gap-4">
      {/* SEGMENTED CONTROL */}
